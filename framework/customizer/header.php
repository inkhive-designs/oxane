...
function oxane_customize_register_header($wp_customize){
    ...
    $wp_customize->get_section('title_tagline')->panel = 'oxane_header_panel';
    //Logo Setting
    ...
    $wp_customize->add_setting(
        'oxane_enable_email_mobile',
        array( 'sanitize_callback' => 'oxane_sanitize_checkbox' )
    );

    $wp_customize->add_control(
        'oxane_enable_email_mobile', array(
            'settings' => 'oxane_enable_email_mobile',
            'label'    => __( 'Enable Mobile & Email','oxane' ),
            'section'  => 'oxane_right_header_content_section',
            'type'     => 'checkbox',
            'default'  => false,
            'active_callback' => 'oxane_disable_search_bar',
    ...
    $wp_customize->add_control('oxane_email_text', array(
        ...
        'type' => 'text',
        'active_callback' => 'oxane_show_email_mobile_options',
    ));
    ...
    function oxane_show_email_mobile_options($control) {

        $option = $control->manager->get_setting('oxane_enable_email_mobile');
        $option2 = $control->manager->get_setting('oxane_replace_search_bar');
